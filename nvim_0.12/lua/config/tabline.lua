...
function M.set_highlights()
	local current_bg = string.format("#%06x", vim.api.nvim_get_hl(0, { name = "Normal" }).bg)
	vim.api.nvim_set_hl(0, "MyBufInactive", { fg = "#ABB2BF", bg = current_bg })
	vim.api.nvim_set_hl(0, "MyBufActive", { fg = "#c9a554", bg = current_bg, bold = true })
	vim.api.nvim_set_hl(0, "MyBufSeparator", { fg = "#21252B", bg = current_bg })
	vim.api.nvim_set_hl(0, "MyBufClose", { fg = "#BF616A", bg = current_bg })
end
